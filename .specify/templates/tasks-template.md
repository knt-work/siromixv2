...
**Tests**: The examples below include test tasks. **Tests are MANDATORY** per Constitution Principle IX. Every feature/function must have unit tests written before or alongside implementation.
...
- [ ] T004 [P] Setup testing framework (pytest/jest/etc.) and configure test runners
...
- [ ] T011 [P] Setup test fixtures, mocks, and shared test utilities
...
- [ ] T012 [P] [US1] Unit tests for [entity/function] in tests/unit/test_[name].py
...
- [ ] T021 [P] [US2] Unit tests for [entity/function] in tests/unit/test_[name].py
...
- [ ] T028 [P] [US3] Unit tests for [entity/function] in tests/unit/test_[name].py
