...
class StorageConfig:
    ...
    ENDPOINT_URL: str | None = os.getenv("STORAGE_ENDPOINT_URL")
    ACCESS_KEY_ID: str | None = os.getenv("STORAGE_ACCESS_KEY_ID")
    SECRET_ACCESS_KEY: str | None = os.getenv("STORAGE_SECRET_ACCESS_KEY")
