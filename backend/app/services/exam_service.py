...
class ExamService:
    ...
    async def create_exam_with_upload(
        ...
        try:
            ...
            try:
                # Artifact creation for the original uploaded DOCX is deferred
                # pending Feature 003 adding an appropriate ArtifactType value.
                # T027: Gracefully skipped for MVP.
                import importlib.util  # noqa: F401  (intentional defer check)
                _ = importlib.util.find_spec('app.models.artifact')  # confirms module exists
